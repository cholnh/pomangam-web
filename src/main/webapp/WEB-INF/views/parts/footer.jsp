...
<body>
	<div class="n-footer">
		...
		<div style="font-size:15px!important;margin-top:12px!important;margin-bottom:12px!important">
		...
		<div class="text-xxxs-center" style="margin-bottom: 12px">
			<a class="n-footer-word" href="https://pf.kakao.com/_xlxbhlj" class="footertext"> © <b>LOCALLECTION</b></a>
			<!-- <a href="#" class="footertext">약관</a> -->
			<a class="n-footer-word" href="./privacy.do" class="footertext">개인정보처리방침</a>
			<a class="n-footer-word" href="./terms.do" class="footertext">약관</a>
			<a class="n-footer-word" href="https://pf.kakao.com/_xlxbhlj" class="footertext">고객센터</a>
		</div>
		<!--
		<p style="font-size:11px; color:darkgray">
	    	...
	    	TEL +82.10-5843-0627 / FAX +82.10-5843-0627 / BUSSINESS NO. 546 05 00933<br>
	    	JOINT REPRESENTATIVE. CHOI, EUN SEONG / CHOI, NAK HYEONG<br>
	    	CHIEF PRIVACY OFFICER. CHOI, NAK HYEONG
	    </p> 
