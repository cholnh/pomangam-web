...
$(function() {
  ...
  /*
  if (mobilecheck()) {
	  $headerLogo.attr('src', 'resources/img/main/ic_main_pomangam_black.png');
	  $headerLogo.css('position', 'absolute');
	  $headerLogo.css('top', '50%');
	  $headerLogo.css('transform', 'translate(0%,-50%)');
  }
  */
  $('#landing-hero')
    .waypoint({
	  ...
	  if (direction === 'up') {
    	...
    	if (mobilecheck()) {
    		 ...
    		 if (direction === 'up') {
	          $navbar.removeClass('sticky');
	          $headerLogo.attr('src', 'resources/img/main/ic_main_locallection_black.png')
	        } else {
	          $navbar.addClass('sticky');
	          $headerLogo.attr('src', 'resources/img/main/ic_main_locallection_white.png')
	        }
    	}
    	*/
      },
